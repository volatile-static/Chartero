...
//             let value:boolean = !Zotero.Prefs.get(preference, true);
//             if (useChecked(elem)) {
//               (elem as XUL.Checkbox).checked = value;
//             } else {
//               (elem as XUL.Checkbox).value = value;
//             }
...
//             Object.keys(options.styles).forEach((k:string) => {
//               const v = options.styles && options.styles[k];
...
//               const v = options.directAttributes && options.directAttributes[k];
...
//               const v = options.attributes && options.attributes[k];
...
//             .filter((e) => e);
//           element.append(...subElements as Node[]);
//         }
//         return element;
//       },
...
//           ) as XUL.Element;
//         }
//         menuItem && anchorElement[insertPosition](menuItem);
//         return true;
//       },
//     };
//   }
