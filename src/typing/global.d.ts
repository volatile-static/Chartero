...
declare interface ZoteroUI {
  ...
  ) => XUL.Element | DocumentFragment | HTMLElement | SVGAElement | undefined;
...
declare interface ElementOptions {
  ...
  attributes?: { [key: string]: string | boolean | number | undefined };
  listeners?: Array<
    | [
        string,
    ...
    | [string, EventListenerOrEventListenerObject | undefined]
  >;
